    ...
    <div className="container mx-auto py-10 px-4 lg:px-8 max-w-3xl text-left">
      <div className="mb-8">
        <Link href="/dashboard" className="inline-block mb-6">
          <Button variant="outline" className="gap-2 h-10 px-4 rounded-xl shadow-sm text-slate-600 hover:text-slate-900">
            <ArrowLeft className="h-4 w-4" /> Back to Dashboard
          </Button>
        </Link>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Your Profile</h1>
        <p className="text-slate-500 mt-2 text-lg">Manage your account settings and translation preferences.</p>
      </div>
