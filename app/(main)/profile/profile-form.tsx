    ...
    <div className="space-y-8">
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            disabled
          />
          <p className="text-xs text-slate-500">Email addresses cannot be changed currently.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
          <div className="space-y-2">
            ...
            <select 
              ...
              className="w-full text-sm bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-700 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all h-11"
            >
      ...
      <div className="pt-8 border-t border-slate-100">
        <Button 
          ...
          className="w-full h-11 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 border-0"
        >
